...
namespace rage
{
	...
	struct tUnkColliderParams2
	{
		...
		Native_CMatrix m_mMatrix;											// 1A0-1E0
		Native_CVector_pad m_vUnk;											// 1E0-1F0
		Native_CVector_pad m_vUnk2;											// 1F0-200
	...
	public:
		...
		Native_CVector_pad m_vPos2;											// 090-0A0
		...
		Native_CVector_pad m_vUnk1;											// 0D0-0E0
		Native_CVector_pad m_vUnk2;											// 0E0-0F0
		Native_CVector_pad m_vUnk3;											// 0F0-100
		Native_CVector_pad m_vPos;											// 100-110
		Native_CVector_pad m_vPedVelocity;									// 110-120
		Native_CVector_pad m_vUnk4;											// 120-130
		uint8_t pad4[0x170];												// 130-2A0
		tUnkColliderParams* m_pUnkParameters;								// 2A0-2A4
		uint8_t pad5[0xDC];													// 2A4-380

		void SetVelocity(Native_CVector* v)
		{
