...
public:
	...
	{
		return ((Native_CMatrix * (__thiscall*)(CDynamicEntity*, int))(AddressSetter::Get(0x5C7710, 0x4F1930)))(this, boneID);
	}
	...
	{
		return ((Native_CMatrix * (__thiscall*)(CDynamicEntity*, int))(AddressSetter::Get(0xD9100, 0x315390)))(this, boneID);
	}
};
