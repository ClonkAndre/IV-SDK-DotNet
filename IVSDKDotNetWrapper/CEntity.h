...
public:
	...
	{
		((void(__thiscall*)(CEntity*, Native_CMatrix*, bool, bool))(*(void***)this)[1])(this, mat, bDontUpdatePhysicsMatrix, bImmediately);
	}

	void Teleport(Native_CVector* v, bool bDontUpdatePhysicsMatrix, bool bImmediately)
	{
		((void(__thiscall*)(CEntity*, Native_CVector*, bool, bool))(*(void***)this)[2])(this, v, bDontUpdatePhysicsMatrix, bImmediately);
	}
