...
public:
	...
	{
		((void(__thiscall*)(CTaskComplexNewGetInVehicle*, CVehicle*, int32_t, uint32_t, int32_t, float))(AddressSetter::Get("CTaskComplexNewGetInVehicle", "CTaskComplexNewGetInVehicle")))(this, veh, getInType, unk27, unk, fUnk);
	}
};