...
public:
	...
	*/
	...
	{
		return ((void(__cdecl*)(uint32_t, uint32_t, uint32_t, CVector*, CVector*, CVector*, CVector*, float, uint32_t, uint32_t, float, float, float, uint32_t, uint32_t, uint32_t))(AddressSetter::Get("CShadows", "StoreStaticShadow")))(
			a1,
			a2,
			nFlags,
			pVec1,
	...
	{
		return ((void(__cdecl*)(uint32_t, uint32_t, uint32_t, CVector*, CVector*, CVector*, CVector*, float, int32_t, int32_t, float, float, float, float, float, int32_t, uint32_t, uint32_t))(AddressSetter::Get("CShadows", "AddSceneLight")))(
			a1,
			nLightType,
			nFlags,
			vDir,
	...
	{
		return ((void(__cdecl*)(int, uint8_t, uint8_t, uint8_t, float, CVector*, float, float, float, int, float, char, char, int))(AddressSetter::Get("CShadows", "RenderCorona")))(
			id,
			r,
			g,
			b,
