...
public:
	...
	{
		((void(__thiscall*)(CDrawSpriteUVDC*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CRGBA, CSprite2d))(AddressSetter::Get("CDrawSpriteUVDC", "CDrawSpriteUVDC")))(this, bl, tl, br, tr, bl2, tl2, br2, tr2, color, sprite);
	}
};
