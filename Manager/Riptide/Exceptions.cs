...
namespace Riptide
{
    ...
    internal class InsufficientCapacityException : Exception
    {
    ...
    internal class NonStaticHandlerException : Exception
    {
    ...
    internal class InvalidHandlerSignatureException : Exception
    {
        /// <summary>The type containing the handler method.</summary>
        public readonly Type DeclaringType;
        /// <summary>The name of the handler method.</summary>
    ...
    internal class DuplicateHandlerException : Exception
    {
