    ...
    internal class Mouse : IDisposable
    {
        ...
        public bool IsVisible
        {
            ...
            set {
                ...
                if (value) Position = new Point(CGame.Resolution.Width / 2, CGame.Resolution.Height / 2);
                isVisible = value;
            }
        }
        ...
        public Point Position
        {
            ...
            set {
                if (IsDisposed)
                    return;
                if (!Main.managerInstance.IsGTAIVWindowInFocus)
                    return;
        ...
        public Mouse(IntPtr device)
        {
            ...
            {
                Main.managerInstance.console.PrintError(string.Format("An error occured while trying to create cursor texture. Mouse cursor will not be available. Details: {0}", ex.ToString()));
                Dispose();
            }
        }
        #endregion
