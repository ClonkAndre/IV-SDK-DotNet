...
namespace Manager.Managers
{
    public class ConsoleManager
    {
        ...
        public void Open()
        {
            ...
            caretTimerID = Main.Instance.StartNewTimerInternel(600, () =>
            {
                showCaret = !showCaret;
            });
        }
        public void Close()
        {
            ...
            Main.Instance.AbortTaskOrTimer(caretTimerID);
        ...
        {
            SharpDX.Mathematics.Interop.RawRectangle rawRect = Main.Instance.LocalD3D9Font.MeasureText(null, text, SharpDX.Direct3D9.FontDrawFlags.Left | SharpDX.Direct3D9.FontDrawFlags.SingleLine);
        ...
        private void QuitCommand()
        {
            ...
            {
                PrintWarning("Could not close GTA IV. GTAIVProcess is null.");
            }
        }
        #endregion
        ...
        internal ConsoleManager()
        {
            ...
            RegisterCommand(Guid.Empty, "ReloadConfig",         (string[] args) => { Main.Instance.LoadConfig(false); });
            RegisterCommand(Guid.Empty, "AbortScripts",         (string[] args) => { Main.Instance.AbortScripts(true); });
            ...
            RegisterCommand(Guid.Empty, "GetRunningScripts",    (string[] args) => { Print(string.Format("There are currently {0} scripts running.", Main.Instance.ActiveScripts.Count.ToString())); });
